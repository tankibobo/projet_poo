...
class ParticuleRoche : public Particule {
    public:
        ...
        ParticuleRoche(double x, double y, double z, double vx, double vy, double vz, double mv, double r, double visc, double masse_v_milieu) : Particule(x,y,z,vx,vy,vz,mv,r,visc,masse_v_milieu) {};
        ParticuleRoche(double x, double y, double z, double mv, double r, double visc, double masse_v_milieu) : Particule(x,y,z,mv,r,visc,masse_v_milieu) {};
        ParticuleRoche(double mv, double r, double visc, double masse_v_milieu) : Particule(mv,r,visc,masse_v_milieu) {};
