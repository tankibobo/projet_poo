...
int main() {
    ...
    Brique* sol = new Brique({0.0, 3.0, -0.25}, 8.0, 6.0, 0.5, {1,0,0}, {0,1,0});
    Brique* murArriere = new Brique({0.0, 6.25, 3.5}, 8.0, 7.0, 0.5, {1,0,0}, {0,0,1});
    Brique* murGauche = new Brique({-4.25, 3.0, 3.5}, 6.0, 7.0, 0.5, {0,1,0}, {0,0,1});
    Brique* murDroit = new Brique({ 4.25, 3.0, 3.5}, 6.0, 7.0, 0.5, {0,1,0}, {0,0,1});
