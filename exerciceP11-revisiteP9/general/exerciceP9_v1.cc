...
int main() {
    ...
    ParticuleNeige* p3 = new ParticuleNeige(1.0, 0.4, Constantes::viscosite_air, Constantes::mv_air, {0.5, sqrt(3)/2, 0});
    ParticuleNeige* p4 = new ParticuleNeige(1.0, 0.4, Constantes::viscosite_air, Constantes::mv_air, {0.5, sqrt(3)/6, sqrt(6)/3});
