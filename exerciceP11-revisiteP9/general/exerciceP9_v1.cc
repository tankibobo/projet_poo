...
int main() {
    ...
    ParticuleNeige* p2 = new ParticuleNeige(1.0, 0, 0, 1.0, 0.4, Constantes::viscosite_air, Constantes::mv_air);
    ParticuleNeige* p3 = new ParticuleNeige(0.5, sqrt(3)/2, 0, 1.0, 0.4, Constantes::viscosite_air, Constantes::mv_air);
    ParticuleNeige* p4 = new ParticuleNeige(0.5, sqrt(3)/6, sqrt(6)/3, 1.0, 0.4, Constantes::viscosite_air, Constantes::mv_air);
