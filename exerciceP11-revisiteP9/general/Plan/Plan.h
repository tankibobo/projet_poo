...
class Dalle : public Plan {
    public:
        Dalle(double x, double y, double z, const Vecteur3D& vect, double l, double L, const Vecteur3D& dir) : Plan(x,y,z,vect), longueur(l), largeur(L), direction_longueur(dir) {
